...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    /**
     * Relation : un utilisateur peut avoir plusieurs tickets (commandes)
     *
    ...
    /**
     * Vérifier si l'utilisateur est admin (via Bouncer ou champ legacy)
     */
    public function isAdmin(): bool
    {
        return $this->isAn('admin') || $this->is_admin === true;
    }
}
